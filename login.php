            ...
            <div class="wrapper fadeInDown">
                ...
                <div id="formContent">
                    <div class="fadeIn first">
                        <div class="divHeader">LOGIN TO FSP</div>                        
                    </div>
                    <form method="post" action="../usr/auth_usr.php" onsubmit="return validateData();">
                      <br>
                    ...
                    <div id="formFooter">
                        <a class="underlineHover" href="#">Forgot Password?</a> &nbsp | &nbsp <a class="underlineHover" href="register.php">Register</a>
                    </div>
                </div>
            </div> 
        </header> 
